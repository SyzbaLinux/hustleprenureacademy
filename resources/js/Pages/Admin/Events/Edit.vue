  ...
  <AdminLayout>
    <div class="max-w-5xl mx-auto space-y-6">
      ...
      <div class="flex items-center gap-4">
        ...
        <div>
          <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Edit {{ event.type === 'course' ? 'Course' : 'Event' }}</h1>
          <p class="text-gray-600 dark:text-gray-400 mt-1">Update event or course information</p>
        </div>
      </div>
      ...
      <form @submit.prevent="submit" class="bg-white dark:bg-slate-800 rounded-lg shadow border border-gray-200 dark:border-slate-700 p-6 space-y-6">
        ...
        <div>
          ...
          <div class="flex items-start gap-6">
            ...
            <div v-else-if="event.flier" class="w-48 h-48 rounded-lg overflow-hidden flex-shrink-0 border-2 border-gray-200 dark:border-slate-600">
        ...
        <div class="flex items-center justify-end gap-3 pt-4 border-t border-gray-200 dark:border-slate-700">
          ...
          >
            ...
            <span v-else>
              ...
              Update {{ form.type === 'course' ? 'Course' : 'Event' }}
            </span>
          </button>
        </div>
      </form>
...
const form = useForm({
  ...
  instructor_ids: props.event.instructors?.map(i => i.id) || [],
  short_description: props.event.short_description || '',
  description: props.event.description,
  location_type: props.event.location_type,
  ...
  duration_hours: props.event.duration_hours || null,
