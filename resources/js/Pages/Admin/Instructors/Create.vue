  ...
  <AdminLayout>
    <div class="max-w-4xl mx-auto space-y-6">
      ...
      <div class="flex items-center gap-4">
        ...
        <div>
          <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Add Instructor</h1>
          <p class="text-gray-600 dark:text-gray-400 mt-1">Create a new instructor profile</p>
        </div>
      </div>
